...
import { detectProjectCommands, createCommandsMessage, escapeGenesisTags } from '~/utils/projectCommands';
...
<genesisArtifact id="imported-files" title="Git Cloned Files" type="bundled">
${fileContents
  .map(
    (file) =>
      `<genesisAction type="file" filePath="${file.path}">
${escapeGenesisTags(file.content)}
</genesisAction>`,
  )
  .join('\n')}
</genesisArtifact>`,
    ...
    <>
      <Button
        ...
        className={classNames(
          'gap-2 bg-genesis-elements-background-depth-1',
          'text-genesis-elements-textPrimary',
          'hover:bg-genesis-elements-background-depth-2',
      ...
      {isDialogOpen && !selectedProvider && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-genesis-elements-borderColor dark:border-genesis-elements-borderColor max-w-md w-full">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-genesis-elements-textPrimary dark:text-genesis-elements-textPrimary">
                  Choose Repository Provider
                </h3>
                <button
                  onClick={() => setIsDialogOpen(false)}
                  className="p-2 rounded-lg bg-transparent hover:bg-genesis-elements-background-depth-1 dark:hover:bg-genesis-elements-background-depth-1 text-genesis-elements-textSecondary dark:text-genesis-elements-textSecondary hover:text-genesis-elements-textPrimary dark:hover:text-genesis-elements-textPrimary transition-all duration-200 hover:scale-105 active:scale-95"
                >
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-genesis-elements-textPrimary dark:text-genesis-elements-textPrimary">
                        GitHub
                      </div>
                      <div className="text-sm text-genesis-elements-textSecondary dark:text-genesis-elements-textSecondary">
      ...
      {isDialogOpen && selectedProvider === 'github' && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-genesis-elements-borderColor dark:border-genesis-elements-borderColor w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b border-genesis-elements-borderColor dark:border-genesis-elements-borderColor flex items-center justify-between">
              <div className="flex items-center gap-3">
