  ...
  useEffect(() => {
    async function fetchProjectData() {
      ...
      try {
        ...
        const project = projects.find((p: { name: string | string[] }) => p.name.includes(`genesis-${chatNumber}`));
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-genesis-elements-item-backgroundActive text-genesis-elements-textSecondary hover:text-[#000000] z-50"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
