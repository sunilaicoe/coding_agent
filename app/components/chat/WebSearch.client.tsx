...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-genesis-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-genesis-elements-borderColor bg-genesis-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-genesis-elements-background-depth-1 text-genesis-elements-textPrimary',
              'placeholder-genesis-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-genesis-elements-button-primary-background text-genesis-elements-button-primary-text',
