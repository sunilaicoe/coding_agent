  ...
  return (
    <div
      className={classNames(
        ...
        'bg-genesis-elements-background-depth-2 dark:bg-genesis-elements-background-depth-3 rounded-lg',
        styles.container,
        className,
      )}
    >
      ...
      <div
        className={classNames(
          'rounded-full bg-genesis-elements-background-depth-3 dark:bg-genesis-elements-background-depth-4 flex items-center justify-center',
      ...
      {description && (
        <p
          className={classNames(
            'text-genesis-elements-textTertiary dark:text-genesis-elements-textTertiary-dark text-center max-w-xs',
            styles.description,
          )}
        >
          {description}
