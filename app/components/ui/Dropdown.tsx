...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-genesis-elements-textPrimary hover:text-genesis-elements-textPrimary',
...
export const DropdownSeparator = () => <DropdownMenu.Separator className="h-px bg-genesis-elements-borderColor my-1" />;
