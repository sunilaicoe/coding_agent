      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-genesis-elements-textPrimary dark:text-genesis-elements-textPrimary-dark'
              : 'text-genesis-elements-textSecondary dark:text-genesis-elements-textSecondary-dark hover:text-genesis-elements-textPrimary dark:hover:text-genesis-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-genesis-elements-textTertiary dark:text-genesis-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
