    ...
    <div className={classNames('space-y-3', className)}>
      ...
      <div className={classNames('grid gap-3', compact ? 'grid-cols-2' : 'grid-cols-2 md:grid-cols-3')}>
        {totalFiles !== undefined && (
          <div className="flex items-center gap-2 text-genesis-elements-textPrimary dark:text-genesis-elements-textPrimary-dark">
            <span className="i-ph:files text-teal-500 w-4 h-4" />
        ...
        {totalSize !== undefined && (
          <div className="flex items-center gap-2 text-genesis-elements-textPrimary dark:text-genesis-elements-textPrimary-dark">
            <span className="i-ph:database text-teal-500 w-4 h-4" />
      ...
      {languages && Object.keys(languages).length > 0 && (
        <div className={compact ? 'pt-1' : 'pt-2'}>
          <div className="flex items-center gap-2 text-genesis-elements-textPrimary dark:text-genesis-elements-textPrimary-dark mb-2">
            <span className="i-ph:code text-teal-500 w-4 h-4" />
