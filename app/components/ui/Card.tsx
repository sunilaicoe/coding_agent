  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-genesis-elements-borderColor bg-genesis-elements-background-depth-1 text-genesis-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-genesis-elements-textSecondary', className)} {...props} />;
  },
);
