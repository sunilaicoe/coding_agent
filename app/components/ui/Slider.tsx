...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-genesis-elements-background-depth-1 overflow-hidden rounded-full p-1">
    ...
    <button
      ...
      className={classNames(
        ...
        selected
          ...
          : 'text-genesis-elements-item-contentDefault hover:text-genesis-elements-item-contentActive',
      )}
    >
      ...
      {selected && (
        <motion.span
          ...
          className="absolute inset-0 z-0 bg-genesis-elements-item-backgroundAccent rounded-full"
        ></motion.span>
      )}
    </button>
  );
