      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-500/20 to-blue-500/20 flex items-center justify-center ring-1 ring-teal-500/30">
              <Cpu className="w-6 h-6 text-teal-500" />
            </div>
            <div>
              <h2 className="text-2xl font-semibold text-genesis-elements-textPrimary">Local AI Providers</h2>
              <p className="text-sm text-genesis-elements-textSecondary">Configure and manage your local AI models</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-genesis-elements-textSecondary">Enable All</span>
              <Switch
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-genesis-elements-background-depth-2 hover:bg-genesis-elements-background-depth-3 border-genesis-elements-borderColor hover:border-teal-500/30 transition-all duration-200 gap-2"
              >
          ...
          {filteredProviders.map((provider) => (
            <div key={provider.name} className="space-y-4">
              ...
              {provider.name === 'Ollama' && provider.settings.enabled && (
                <Card className="mt-4 bg-genesis-elements-background-depth-2">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <PackageOpen className="w-5 h-5 text-teal-500" />
                        <h3 className="text-lg font-semibold text-genesis-elements-textPrimary">Installed Models</h3>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                        ...
                        className="bg-transparent hover:bg-genesis-elements-background-depth-2"
                      >
                        {isLoadingModels ? (
                  ...
                  <CardContent className="space-y-4">
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        <PackageOpen className="w-16 h-16 mx-auto text-genesis-elements-textTertiary mb-4" />
                        <h3 className="text-lg font-medium text-genesis-elements-textPrimary mb-2">No Models Installed</h3>
                        <p className="text-sm text-genesis-elements-textSecondary mb-4">
                          Visit{' '}
                          <a
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-teal-500/8 to-teal-600/8 hover:from-teal-500/15 hover:to-teal-600/15 border-teal-500/25 hover:border-teal-500/40 transition-all duration-300 gap-2 group shadow-sm hover:shadow-md font-medium"
                          _asChild
                        >
                          <a
                            href="https://ollama.com/library"
                ...
                <Card className="mt-4 bg-genesis-elements-background-depth-2">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-semibold text-genesis-elements-textPrimary">Available Models</h3>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                  ...
                  <CardContent className="space-y-4">
                    {isLoadingLMStudioModels ? (
                      ...
                      <div className="text-center py-8">
                        <Monitor className="w-16 h-16 mx-auto text-genesis-elements-textTertiary mb-4" />
                        <h3 className="text-lg font-medium text-genesis-elements-textPrimary mb-2">No Models Available</h3>
                        <p className="text-sm text-genesis-elements-textSecondary mb-4">
                      ...
                      <div className="grid gap-4">
                        {lmStudioModels.map((model) => (
                          <Card key={model.id} className="bg-genesis-elements-background-depth-3">
                            <CardContent className="p-4">
                              <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                  <h4 className="text-sm font-medium text-genesis-elements-textPrimary font-mono">
                                    {model.id}
                                  </h4>
        ...
        {filteredProviders.length === 0 && (
          <Card className="bg-genesis-elements-background-depth-2">
            <CardContent className="p-8 text-center">
              <Server className="w-16 h-16 mx-auto text-genesis-elements-textTertiary mb-4" />
              <h3 className="text-lg font-medium text-genesis-elements-textPrimary mb-2">No Local Providers Available</h3>
