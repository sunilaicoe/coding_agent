              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'transition-all duration-200',
                    provider.settings.enabled ? 'text-teal-500' : 'text-bolt-elements-textSecondary',
                  )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-2">
                    <div>
                      <h4 className="text-sm font-medium text-bolt-elements-textPrimary group-hover:text-teal-500 transition-colors">
                        {provider.name}
                      </h4>
