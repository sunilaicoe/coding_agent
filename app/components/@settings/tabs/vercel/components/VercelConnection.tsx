      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-genesis-elements-textPrimary">Vercel Connection</h3>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-2 text-sm text-genesis-elements-textSecondary">
                ...
                <div className="mt-2 text-xs text-genesis-elements-textSecondary bg-genesis-elements-background-depth-1 p-2 rounded">
                  <p className="flex items-center gap-1">
                    ...
                    <code className="px-1 py-0.5 bg-genesis-elements-background-depth-2 rounded text-xs">
            ...
            {fetchingStats ? (
              ...
              <div>
                <button
                  ...
                  className="w-full bg-transparent text-left text-sm font-medium text-genesis-elements-textPrimary mb-3 flex items-center gap-2"
                >
                  ...
                  <div className="grid gap-3">
                    {connection.stats.projects.map((project) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block p-4 rounded-lg border border-genesis-elements-borderColor hover:border-genesis-elements-borderColorActive transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                              ...
                              {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                                <>
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-genesis-elements-borderColorActive"
                                  >
                          ...
                          {project.framework && (
                            <div className="text-xs text-genesis-elements-textSecondary px-2 py-1 rounded-md bg-[#F0F0F0] dark:bg-[#252525]">
                              <span className="flex items-center gap-1">
