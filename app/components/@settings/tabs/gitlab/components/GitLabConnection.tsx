...
export default function GitLabConnection({ connectionTest, onTestConnection }: GitLabConnectionProps) {
  ...
  return (
    <motion.div
      className="bg-genesis-elements-background border border-genesis-elements-borderColor rounded-lg"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-medium text-genesis-elements-textPrimary">GitLab Connection</h3>
          </div>
        </div>

        {!isConnected && (
          <div className="text-xs text-genesis-elements-textSecondary bg-genesis-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <span className="i-ph:lightbulb w-3.5 h-3.5 text-genesis-elements-icon-success" />
              <span className="font-medium">Tip:</span> You can also set the{' '}
              <code className="px-1 py-0.5 bg-genesis-elements-background-depth-2 rounded">VITE_GITLAB_ACCESS_TOKEN</code>{' '}
              environment variable to connect automatically.
            </p>
            <p>
              For self-hosted GitLab instances, also set{' '}
              <code className="px-1 py-0.5 bg-genesis-elements-background-depth-2 rounded">
        ...
        <form onSubmit={handleConnect}>
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="block text-sm text-genesis-elements-textSecondary mb-2">GitLab URL</label>
              <input
                type="text"
                value={gitlabUrl}
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      className="flex items-center gap-2 hover:bg-genesis-elements-item-backgroundActive/10 hover:text-genesis-elements-textPrimary dark:hover:text-genesis-elements-textPrimary transition-colors"
                    >
