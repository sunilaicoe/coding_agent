      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            ...
            const setUploadedFiles = (window as any).__GENESIS_SET_UPLOADED_FILES__;
            const setImageDataList = (window as any).__GENESIS_SET_IMAGE_DATA_LIST__;
            const uploadedFiles = (window as any).__GENESIS_UPLOADED_FILES__ || [];
            const imageDataList = (window as any).__GENESIS_IMAGE_DATA_LIST__ || [];
