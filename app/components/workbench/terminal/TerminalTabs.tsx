  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-genesis-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-genesis-elements-background-depth-2 border-y border-genesis-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-genesis-elements-terminals-buttonBackground text-genesis-elements-textSecondary hover:text-genesis-elements-textPrimary':
                            isActive,
                          'bg-genesis-elements-background-depth-2 text-genesis-elements-textSecondary hover:bg-genesis-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-genesis-elements-terminals-buttonBackground text-genesis-elements-textPrimary': isActive,
                            'bg-genesis-elements-background-depth-2 text-genesis-elements-textSecondary hover:bg-genesis-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-genesis-elements-textTertiary hover:text-genesis-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachGenesisTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting genesis terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachGenesisTerminal(terminal)}
