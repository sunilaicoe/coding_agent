      ...
      <PanelGroup direction="vertical">
        <Panel defaultSize={showTerminal ? DEFAULT_EDITOR_SIZE : 100} minSize={20}>
          <PanelGroup direction="horizontal">
            <Panel defaultSize={20} minSize={15} collapsible className="border-r border-gray-200 dark:border-[#3c3c3c] bg-[#f3f3f3] dark:bg-[#252526]">
              <div className="h-full">
                <Tabs.Root defaultValue="files" className="flex flex-col h-full">
                  <PanelHeader className="w-full text-sm font-medium text-gray-500 dark:text-gray-400 px-1">
                      ...
                      <Tabs.List className="h-full flex-shrink-0 flex items-center">
                        <Tabs.Trigger
                          ...
                          className={classNames(
                            'h-full bg-transparent hover:bg-gray-100 dark:hover:bg-white/5 py-0.5 px-2 rounded-lg text-sm font-medium text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 data-[state=active]:text-gray-900 dark:data-[state=active]:text-gray-100',
                          )}
                        >
                          Files
                        </Tabs.Trigger>
