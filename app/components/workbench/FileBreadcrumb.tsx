              ...
              <DropdownMenu.Trigger asChild>
                <span
                  ...
                  className={classNames('flex items-center gap-1.5 cursor-pointer shrink-0', {
                    'text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-200': !isActive,
                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] min-w-[300px] overflow-scroll bg-white dark:bg-[#252526] border border-gray-200 dark:border-gray-600 shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
