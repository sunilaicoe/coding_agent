...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
    ...
    return (
      <div
        ...
        style={{
          ...
          height: '100%',
          cursor: 'ew-resize',
          background: 'var(--genesis-elements-background-depth-4, rgba(0,0,0,.3))',
          display: 'flex',
          alignItems: 'center',
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--genesis-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--genesis-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  const GripIcon = () => (
    ...
    >
      <div
        style={{
          color: 'var(--genesis-elements-textSecondary, rgba(0,0,0,0.5))',
          fontSize: '10px',
          lineHeight: '5px',
          userSelect: 'none',
          marginLeft: '1px',
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-[#f3f3f3] dark:bg-[#252526] p-2 flex items-center gap-2 border-b border-gray-200 dark:border-[#3c3c3c]">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-genesis-elements-background-depth-3' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-genesis-elements-preview-addressBar-background border border-genesis-elements-borderColor text-genesis-elements-preview-addressBar-text rounded-full px-1 py-1 text-sm hover:bg-genesis-elements-preview-addressBar-backgroundHover hover:focus-within:bg-genesis-elements-preview-addressBar-backgroundActive focus-within:bg-genesis-elements-preview-addressBar-backgroundActive focus-within-border-genesis-elements-borderColorActive focus-within:text-genesis-elements-preview-addressBar-textActive">
          <PortDropdown
        ...
        <div className="flex items-center gap-2">
          ...
          {verificationStatus === 'verifying' && (
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">
              <div className="i-ph:spinner-gap animate-spin" />
              {verificationRound}/25
            </div>
          )}
          {verificationStatus === 'fixing' && (
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-[10px] font-bold text-amber-600 dark:text-amber-400 uppercase tracking-wider">
              <div className="i-ph:wrench animate-pulse" />
              Fixing
            </div>
          )}
          {verificationStatus === 'passed' && (
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-[10px] font-bold text-green-600 dark:text-green-400 uppercase tracking-wider">
          ...
          {verificationStatus === 'failed' && (
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-[10px] font-bold text-amber-600 dark:text-amber-400 uppercase tracking-wider">
              ...
              {verificationCleanStreak}/{verificationRound}
            </div>
          )}
          ...
          <IconButton
            ...
            className={
              isInspectorMode ? 'bg-genesis-elements-background-depth-3 !text-genesis-elements-item-contentAccent' : ''
            }
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-genesis-elements-textTertiary hover:text-genesis-elements-textPrimary`}
                        onClick={() => {
                          openInNewTab();
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-genesis-elements-textTertiary">Show Device Frame</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-genesis-elements-textTertiary">Landscape Mode</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
      ...
      <div className="flex-1 border-t border-genesis-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? (showDeviceFrameInPreview ? '100%' : `${widthPercent}%`) : '100%',
            height: '100%',
            overflow: 'auto',
            background: 'var(--genesis-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
        ...
        >
          {activePreview ? (
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-genesis-elements-background-depth-1"
                  src={iframeUrl}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
            ...
            <div className="flex flex-col w-full h-full justify-center items-center bg-white dark:bg-[#0a0a0a] text-gray-400 gap-3">
              ...
              <span className="text-xs text-gray-300 dark:text-gray-600">Waiting for dev server to start...</span>
            </div>
          )}
            ...
            <>
              ...
              <div
                style={{
                  ...
                  background: 'var(--genesis-elements-background-depth-3, rgba(0,0,0,0.7))',
                  color: 'var(--genesis-elements-textPrimary, white)',
                  padding: '2px 8px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  pointerEvents: 'none',
