...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out genesis artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ['Foo bar <g', 'Foo bar '],
      ['Foo bar <ge', 'Foo bar '],
      ['Foo bar <genesisa', 'Foo bar <genesisa'],
      ['Foo bar <genesis', 'Foo bar '],
      ['Foo bar <genesisa', 'Foo bar <genesisa'],
      ['Foo bar <genesisA', 'Foo bar '],
      ['Foo bar <genesisArtifacs></genesisArtifact>', 'Foo bar <genesisArtifacs></genesisArtifact>'],
      ['Before <oltArtfiact>foo</genesisArtifact> After', 'Before <oltArtfiact>foo</genesisArtifact> After'],
      ['Before <genesisArtifactt>foo</genesisArtifact> After', 'Before <genesisArtifactt>foo</genesisArtifact> After'],
    ])('should correctly parse chunks and strip out genesis artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <genesisArtifact title="Some title" id="artifact_1">foo bar</genesisArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <genesisArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</genesisArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</genesisArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</genesisArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/genesisArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <genesisArtifact title="Some title" id="artifact_1">foo</genesisArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <genesisArtifact title="Some title" id="artifact_1"><genesisAction type="shell">npm install</genesisAction></genesisArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <genesisArtifact title="Some title" id="artifact_1"><genesisAction type="shell">npm install</genesisAction><genesisAction type="file" filePath="index.js">some content</genesisAction></genesisArtifact> After',
        {
          output: 'Before  After',
