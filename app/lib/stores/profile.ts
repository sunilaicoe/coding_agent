...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('genesis_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('genesis_profile', JSON.stringify(profileStore.get()));
  }
};
